...
public class BoardClient {
	public static void main(String[] args) {
		...
		BoardService service = (BoardService)ctx.getBean("boardService");
		  ...
		  insertDto.setTitle("스프링 프레임워크"); // insertDto.setContent("스프링 프레임워크 게시판");
		  insertDto.setContent("스프링 프레임워크"); // insertDto.setContent("스프링 프레임워크 게시판");
