...
public class UploadController {
	...
	public void uploadPost(MultipartFile[] uploadFile) {
		...
		for(MultipartFile multipartFile : uploadFile) {
			...
			log.info("파일전송이 되었느냐 허허 파일명 : "+multipartFile.getOriginalFilename());
			log.info("파일전송이 되었느냐 허허 파일 크기: "+multipartFile.getSize());
	...
	// 파일 하나 첨부할때는 이런식으로 처리한다 
//	@PostMapping("/uploadForm")
//	public void uploadPost(MultipartFile uploadFile) {
//		log.info("파일전송이 되었느냐 허허 파일명 : "+uploadFile.getOriginalFilename());
//		log.info("파일전송이 되었느냐 허허 파일 크기: "+uploadFile.getSize());
//		
//		String uploadPath = "c:\\upload";
//		
